...
> [!NOTE]
> Backend and frontend coverage reports are generated by separate CI jobs. Coverage badges remain
> pending until Personal Workspace has its own measured baseline; source-project values are not reused.
