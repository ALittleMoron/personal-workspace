...
class TestAdminFilesApi(ApiTestCase):
    ...
    def test_list_maps_required_attachment_filter(self) -> None:
        ...
        response = self.api.get_admin_files(purpose=FilePurpose.ATTACHMENT.value)
    ...
    def test_get_and_update_map_file_id_and_metadata(self) -> None:
        ...
        detail_response = self.api.get_admin_file(file_id=self.file_id)
        update_response = self.api.put_admin_file(
            file_id=self.file_id,
